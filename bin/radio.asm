...
_handle_radio_request_sloc2_1_0:
	.ds 2
_handle_radio_request_sloc3_1_0:
	.ds 2
;--------------------------------------------------------
...
_enter_promiscuous_mode_PARM_2:
	.ds 1
_enter_promiscuous_mode_prefix_65536_34:
	.ds 3
_enter_promiscuous_mode_address_131072_37:
	.ds 2
...
_enter_promiscuous_mode_generic_PARM_4:
	.ds 1
_enter_promiscuous_mode_generic_prefix_65536_38:
	.ds 3
_enter_promiscuous_mode_generic_address_131072_41:
	.ds 2
_configure_address_PARM_2:
	.ds 1
_configure_address_address_65536_43:
	.ds 3
_configure_mac_PARM_2:
	.ds 1
_configure_mac_PARM_3:
	.ds 1
_configure_mac_feature_65536_45:
	.ds 1
_configure_phy_PARM_2:
	.ds 1
_configure_phy_PARM_3:
	.ds 1
_configure_phy_config_65536_47:
	.ds 1
_spi_transfer_byte_65536_49:
	.ds 1
_spi_write_PARM_2:
	.ds 3
_spi_write_PARM_3:
	.ds 1
_spi_write_command_65536_51:
	.ds 1
_spi_read_PARM_2:
	.ds 3
_spi_read_PARM_3:
	.ds 1
_spi_read_command_65536_54:
	.ds 1
_write_register_byte_PARM_2:
	.ds 1
_write_register_byte_reg_65536_57:
	.ds 1
_read_register_byte_reg_65536_59:
	.ds 1
_read_register_byte_value_65536_60:
	.ds 1
_crc_update_PARM_2:
	.ds 1
_crc_update_PARM_3:
	.ds 1
_crc_update_crc_65536_61:
	.ds 2
_handle_radio_request_PARM_2:
	.ds 3
_handle_radio_request_request_65536_63:
	.ds 1
_handle_radio_request_command_131072_66:
	.ds 9
_handle_radio_request_value_131072_75:
	.ds 1
_handle_radio_request_crc_262144_80:
	.ds 2
_handle_radio_request_crc_given_262144_80:
	.ds 2
_handle_radio_request_payload_262144_80:
	.ds 37
_handle_radio_request_payload_262144_91:
	.ds 37
;--------------------------------------------------------
...
;prefix                    Allocated with name '_enter_promiscuous_mode_prefix_65536_34'
;x                         Allocated with name '_enter_promiscuous_mode_x_65536_35'
;address                   Allocated with name '_enter_promiscuous_mode_address_131072_37'
;------------------------------------------------------------
...
_enter_promiscuous_mode:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_enter_promiscuous_mode_prefix_65536_34
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;	src/radio.c:30: uint8_t address[2] = { pm_prefix[0], (pm_prefix[0] & 0x80) == 0x80 ? 0xAA : 0x55 };
	mov	dptr,#_pm_prefix
	movx	a,@dptr
	mov	dptr,#_enter_promiscuous_mode_address_131072_37
	movx	@dptr,a
	mov	dptr,#_pm_prefix
	movx	a,@dptr
	mov	r5,a
...
00115$:
	...
	mov	r5,#0x00
00116$:
	mov	dptr,#(_enter_promiscuous_mode_address_131072_37 + 0x0001)
	mov	a,r4
	movx	@dptr,a
...
;prefix                    Allocated with name '_enter_promiscuous_mode_generic_prefix_65536_38'
;x                         Allocated with name '_enter_promiscuous_mode_generic_x_65536_39'
;address                   Allocated with name '_enter_promiscuous_mode_generic_address_131072_41'
;------------------------------------------------------------
...
_enter_promiscuous_mode_generic:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_enter_promiscuous_mode_generic_prefix_65536_38
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;	src/radio.c:70: uint8_t address[2] = { pm_prefix[0], (pm_prefix[0] & 0x80) == 0x80 ? 0xAA : 0x55 };
	mov	dptr,#_pm_prefix
	movx	a,@dptr
	mov	dptr,#_enter_promiscuous_mode_generic_address_131072_41
	movx	@dptr,a
	mov	dptr,#_pm_prefix
	movx	a,@dptr
	mov	r5,a
...
00119$:
	...
	mov	r5,#0x00
00120$:
	mov	dptr,#(_enter_promiscuous_mode_generic_address_131072_41 + 0x0001)
	mov	a,r4
	movx	@dptr,a
...
;address                   Allocated with name '_configure_address_address_65536_43'
;------------------------------------------------------------
...
_configure_address:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_configure_address_address_65536_43
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;feature                   Allocated with name '_configure_mac_feature_65536_45'
;------------------------------------------------------------
...
_configure_mac:
	mov	a,dpl
	mov	dptr,#_configure_mac_feature_65536_45
	movx	@dptr,a
...
;config                    Allocated with name '_configure_phy_config_65536_47'
;------------------------------------------------------------
...
_configure_phy:
	mov	a,dpl
	mov	dptr,#_configure_phy_config_65536_47
	movx	@dptr,a
...
;------------------------------------------------------------
;byte                      Allocated with name '_spi_transfer_byte_65536_49'
;------------------------------------------------------------
...
_spi_transfer:
	mov	a,dpl
	mov	dptr,#_spi_transfer_byte_65536_49
	movx	@dptr,a
...
;command                   Allocated with name '_spi_write_command_65536_51'
;x                         Allocated with name '_spi_write_x_65536_52'
;------------------------------------------------------------
...
_spi_write:
	mov	a,dpl
	mov	dptr,#_spi_write_command_65536_51
	movx	@dptr,a
...
;command                   Allocated with name '_spi_read_command_65536_54'
;x                         Allocated with name '_spi_read_x_65536_55'
;------------------------------------------------------------
...
_spi_read:
	mov	a,dpl
	mov	dptr,#_spi_read_command_65536_54
	movx	@dptr,a
...
;reg                       Allocated with name '_write_register_byte_reg_65536_57'
;------------------------------------------------------------
...
_write_register_byte:
	mov	a,dpl
	mov	dptr,#_write_register_byte_reg_65536_57
	movx	@dptr,a
...
;------------------------------------------------------------
;reg                       Allocated with name '_read_register_byte_reg_65536_59'
;value                     Allocated with name '_read_register_byte_value_65536_60'
;------------------------------------------------------------
...
_read_register_byte:
	mov	a,dpl
	mov	dptr,#_read_register_byte_reg_65536_59
	movx	@dptr,a
;	src/radio.c:157: read_register(reg, &value, 1);
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_spi_read_PARM_2
	mov	a,#_read_register_byte_value_65536_60
	movx	@dptr,a
	mov	a,#(_read_register_byte_value_65536_60 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	src/radio.c:158: return value;
	mov	dptr,#_read_register_byte_value_65536_60
	movx	a,@dptr
;	src/radio.c:159: }
	mov	dpl,a
	ret
...
;crc                       Allocated with name '_crc_update_crc_65536_61'
;------------------------------------------------------------
...
_crc_update:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_crc_update_crc_65536_61
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;sloc3                     Allocated with name '_handle_radio_request_sloc3_1_0'
;data                      Allocated with name '_handle_radio_request_PARM_2'
;request                   Allocated with name '_handle_radio_request_request_65536_63'
;command                   Allocated with name '_handle_radio_request_command_131072_66'
;command_length            Allocated with name '_handle_radio_request_command_length_131072_66'
;x                         Allocated with name '_handle_radio_request_x_131072_66'
;value                     Allocated with name '_handle_radio_request_value_131072_75'
;x                         Allocated with name '_handle_radio_request_x_262144_80'
;offset                    Allocated with name '_handle_radio_request_offset_262144_80'
;payload_length            Allocated with name '_handle_radio_request_payload_length_262144_80'
;crc                       Allocated with name '_handle_radio_request_crc_262144_80'
;crc_given                 Allocated with name '_handle_radio_request_crc_given_262144_80'
;payload                   Allocated with name '_handle_radio_request_payload_262144_80'
;x                         Allocated with name '_handle_radio_request_x_262144_91'
;payload                   Allocated with name '_handle_radio_request_payload_262144_91'
;elapsed                   Allocated with name '_handle_radio_request_elapsed_131072_94'
;status                    Allocated with name '_handle_radio_request_status_131072_94'
;__2621440005              Allocated with name '_handle_radio_request___2621440005_262144_104'
;us                        Allocated with name '_handle_radio_request_us_327680_105'
;__1966080007              Allocated with name '_handle_radio_request___1966080007_196608_107'
;us                        Allocated with name '_handle_radio_request_us_262144_108'
;address_start             Allocated with name '_handle_radio_request_address_start_131072_101'
;__1966080009              Allocated with name '_handle_radio_request___1966080009_196608_110'
;us                        Allocated with name '_handle_radio_request_us_262144_111'
;------------------------------------------------------------
...
_handle_radio_request:
	mov	a,dpl
	mov	dptr,#_handle_radio_request_request_65536_63
	movx	@dptr,a
...
;	src/radio.c:185: const uint8_t command[9] = {'E', 'n', 't', 'e', 'r', ' ', 'I', 'C', 'P'};
	mov	dptr,#_handle_radio_request_command_131072_66
	mov	a,#0x45
	movx	@dptr,a
	mov	dptr,#(_handle_radio_request_command_131072_66 + 0x0001)
	mov	a,#0x6e
	movx	@dptr,a
	mov	dptr,#(_handle_radio_request_command_131072_66 + 0x0002)
	mov	a,#0x74
	movx	@dptr,a
	mov	dptr,#(_handle_radio_request_command_131072_66 + 0x0003)
	mov	a,#0x65
	movx	@dptr,a
	mov	dptr,#(_handle_radio_request_command_131072_66 + 0x0004)
	mov	a,#0x72
	movx	@dptr,a
	mov	dptr,#(_handle_radio_request_command_131072_66 + 0x0005)
	mov	a,#0x20
	movx	@dptr,a
	mov	dptr,#(_handle_radio_request_command_131072_66 + 0x0006)
	mov	a,#0x49
	movx	@dptr,a
	mov	dptr,#(_handle_radio_request_command_131072_66 + 0x0007)
	mov	a,#0x43
	movx	@dptr,a
	mov	dptr,#(_handle_radio_request_command_131072_66 + 0x0008)
	mov	a,#0x50
	movx	@dptr,a
...
;	src/radio.c:191: AESIV = command[x];
	mov	a,r5
	mov	_AESIA1,a
	add	a,#_handle_radio_request_command_131072_66
	mov	dpl,a
	mov	a,r6
	addc	a,#(_handle_radio_request_command_131072_66 >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	_AESIV,a
;	src/radio.c:188: for(x = 0; x < command_length; x++)
...
;	src/radio.c:253: read_register(FIFO_STATUS, &value, 1);
	mov	dptr,#_spi_read_PARM_2
	mov	a,#_handle_radio_request_value_131072_75
	movx	@dptr,a
	mov	a,#(_handle_radio_request_value_131072_75 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	src/radio.c:254: if((value & 1) == 0)
	mov	dptr,#_handle_radio_request_value_131072_75
	movx	a,@dptr
	jnb	acc.0,00530$
	ljmp	00133$
00530$:
...
00228$:
	...
	mov	r1,a
	mov	a,r0
	add	a,#_handle_radio_request_payload_262144_80
	mov	_handle_radio_request_sloc1_1_0,a
	mov	a,r1
	addc	a,#(_handle_radio_request_payload_262144_80 >> 8)
	mov	(_handle_radio_request_sloc1_1_0 + 1),a
	mov	a,r4
	add	a,#_pm_prefix
	mov	dpl,a
...
;	src/radio.c:310: payload_length = payload[5] >> 2;
	push	ar4
	push	ar5
	mov	dptr,#(_handle_radio_request_payload_262144_80 + 0x0005)
	movx	a,@dptr
	rr	a
	rr	a
	anl	a,#0x3f
...
;	src/radio.c:319: crc_given = (crc_given << 8) | (crc_given >> 8);
	...
	mov	dptr,#_handle_radio_request_crc_given_262144_80
...
;	src/radio.c:323: crc = 0xFFFF;
	mov	dptr,#_handle_radio_request_crc_262144_80
	mov	a,#0xff
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
...
;	src/radio.c:332: memcpy(in1buf, payload, 5);
	...
	mov	a,#_handle_radio_request_payload_262144_80
	movx	@dptr,a
	mov	a,#(_handle_radio_request_payload_262144_80 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	src/radio.c:336: in1buf[5+x] = ((payload[6 + x] << 1) & 0xFF) | (payload[7 + x] >> 7);
	...
	rlc	a
	subb	a,acc
	mov	_handle_radio_request_sloc3_1_0,r1
	mov	(_handle_radio_request_sloc3_1_0 + 1),#0x00
	mov	a,#0x07
	add	a,r0
	mov	r0,a
	rlc	a
	...
	mov	r1,a
	mov	r2,#0x00
	mov	a,_handle_radio_request_sloc3_1_0
	orl	ar1,a
	mov	a,(_handle_radio_request_sloc3_1_0 + 1)
	orl	ar2,a
	mov	dpl,_handle_radio_request_sloc1_1_0
	mov	dph,(_handle_radio_request_sloc1_1_0 + 1)
	mov	a,r1
...
00241$:
	...
	mov	r2,a
	mov	a,r1
	add	a,#_handle_radio_request_payload_262144_91
	mov	r1,a
	mov	a,r2
	addc	a,#(_handle_radio_request_payload_262144_91 >> 8)
	mov	r2,a
	mov	a,r5
	add	a,#_pm_prefix
	mov	dpl,a
...
;	src/radio.c:356: memcpy(in1buf, payload, pm_prefix_length + pm_payload_length);
	...
	mov	r5,a
	mov	dptr,#_memcpy_PARM_2
	mov	a,#_handle_radio_request_payload_262144_91
	movx	@dptr,a
	mov	a,#(_handle_radio_request_payload_262144_91 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
