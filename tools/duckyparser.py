# This class is for creating the script for injectong to the victim computer, parsing the script
# by the type of the keyboard.
...
class DuckyParser(object):
    ...
    def __init__(self, attack_script, layout=None):
        if layout:
            key_mapping = keymap.mapping[layout] # the layout of the keyboard: US, CH and etc..
        else:
